...
from bijux_cli.commands.plugins.list import list_plugin
from bijux_cli.commands.plugins.scaffold import scaffold_plugin
from bijux_cli.commands.plugins.uninstall import uninstall_plugin
