...
impl Default for RouteRegistry {
    fn default() -> Self {
        let built_ins = BTreeSet::from([
            ...
            "dev cli scripts-audit".to_string(),
        ...
        let aliases = BTreeMap::from([
            ...
            ("dev docs".to_string(), "dev cli docs".to_string()),
            ("dev docs-audit".to_string(), "dev cli docs-audit".to_string()),
            ("dev status".to_string(), "dev cli status".to_string()),
            ("dev scripts-audit".to_string(), "dev cli scripts-audit".to_string()),
            ("dev script-audit".to_string(), "dev cli script-audit".to_string()),
            ("dev snapshots-audit".to_string(), "dev cli snapshots-audit".to_string()),
            ("dev fixture-audit".to_string(), "dev cli fixture-audit".to_string()),
            ("dev crate-health".to_string(), "dev cli crate-health".to_string()),
