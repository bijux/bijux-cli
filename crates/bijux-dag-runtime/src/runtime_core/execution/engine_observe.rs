...
pub fn node_eligible_events(node_ids: &[String], ts: u128, reason: &str) -> Vec<serde_json::Value> {
    node_ids
        .iter()
        .map(|node_id| {
            json!({
