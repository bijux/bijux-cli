...
pub fn verify_registry_access_bypass(root: &Path) -> Result<(), String> {
    ...
    let allowlist = [
        ...
        "crates/bijux-dev/tests/evidence_registry_contracts.rs",
        "crates/bijux-dev/tests/evidence_family_boundary_contracts.rs",
        "crates/bijux-dev/tests/evidence_access_contracts.rs",
        "crates/bijux-dev/tests/evidence_control_plane_suites_contracts.rs",
