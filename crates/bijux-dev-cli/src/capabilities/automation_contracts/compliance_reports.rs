...
use super::status_contracts::build_status_contracts_report;
use super::support::{
...
pub fn build_flaky_tests_report(workspace_root: &Path) -> Value {
    ...
    json!({
        ...
        "generator": "crates/bijux-dev-cli/src/capabilities/automation_contracts/compliance_reports.rs::build_flaky_tests_report",
    })
}
