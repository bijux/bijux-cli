...
mod tests {
    ...
    fn write_run_fixture(run: &std::path::Path) {
        ...
        std::fs::write(
            ...
            r#"{"files":[{"node_id":"extract","node_fingerprint":"fp-node","name":"report","kind":"file","media_type":"application/json","size_bytes":2,"sha256":"abc","path":"nodes/extract/outputs/report.json"}]}"#,
        )
