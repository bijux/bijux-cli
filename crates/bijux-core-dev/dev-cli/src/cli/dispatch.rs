...
/// Runtime-owned query adapter used by maintainer command dispatch.
...
pub fn owns_path(normalized_path: &[String]) -> bool {
    match normalized_path {
        ...
        [group, subcommand, _] if group == "maintenance" && subcommand == "status" => true,
        _ => false,
    }
}
...
mod tests {
    ...
    #[test]
    fn owns_path_matches_maintainer_dispatch_surface() {
        ...
        assert!(!owns_path(&["unknown".into(), "leaf".into()]));
    }
}
