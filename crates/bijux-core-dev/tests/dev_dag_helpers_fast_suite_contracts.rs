...
fn helper_fast_suite_config_includes_required_contract_tests() {
    ...
    for required in [
        "crates/bijux-core-dev/tests/dev_dag_direct_test_presence_contracts.rs",
        "crates/bijux-core-dev/tests/dev_dag_helpers_fast_suite_contracts.rs",
        "crates/bijux-core-dev/tests/dev_dag_helper_small_module_test_gate_contracts.rs",
        "crates/bijux-core-dev/tests/dev_dag_reporting_integrity_contracts.rs",
    ] {
        assert!(
