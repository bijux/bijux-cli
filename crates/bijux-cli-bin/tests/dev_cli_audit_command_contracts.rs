...
fn script_docs_crate_health_text_snapshot_heads_match() {
    let cases = [
        (
            ...
            include_str!("snapshots/dev_cli_script_audit_text_head.txt"),
        ),
        (
            vec!["dev", "cli", "docs-audit", "--format", "text"],
            include_str!("snapshots/dev_cli_docs_audit_text_head.txt"),
        ),
        (
            vec!["dev", "cli", "crate-health", "--format", "text"],
            include_str!("snapshots/dev_cli_crate_health_text_head.txt"),
        ),
    ];
