...
impl TelemetrySpan {
    ...
    pub fn finish_success(&self, exit_code: i32, stdout_bytes: usize, stderr_bytes: usize) {
        self.record(
            "invocation.finish",
            json!({
                "result": "ok",
    ...
    /// Record failed invocation completion.
