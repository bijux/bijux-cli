...
use super::{CommandPath, Namespace, NamespaceMetadata, OFFICIAL_PRODUCT_NAMESPACES};
...
impl Default for RouteRegistry {
    ...
    fn default() -> Self {
        let built_ins = BTreeSet::from([
            ...
            "dev cli dashboard".to_string(),
            "dev cli quickcheck".to_string(),
            "dev cli truth".to_string(),
            "dev cli blockers".to_string(),
            "dev cli next".to_string(),
            "dev cli plugin-health".to_string(),
            "dev cli status".to_string(),
            "dev cli maintenance-audit".to_string(),
