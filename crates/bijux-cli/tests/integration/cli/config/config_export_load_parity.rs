...
#[test]
fn config_export_json_yaml_and_text_snapshots() {
    ...
    assert_eq!(
        ...
        include_str!("../../../data/golden/cli_surface/config_export_json_compact.txt")
    );
    ...
    assert_eq!(
        ...
        include_str!("../../../data/golden/cli_surface/config_export_yaml_pretty.txt")
    );
    ...
    assert_eq!(
        ...
        include_str!("../../../data/golden/cli_surface/config_export_text.txt")
    );
}
...
fn config_load_missing_file_fails_and_path_traversal_style_path_works() {
    ...
    let traversal = Command::new(env!("CARGO_BIN_EXE_bijux"))
        .args([
            "cli",
            "config",
            "load",
