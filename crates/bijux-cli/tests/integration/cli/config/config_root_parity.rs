...
fn root_config_output_snapshots_text_json_yaml() {
    ...
    assert_eq!(
        ...
        include_str!("../../../data/golden/cli_surface/config_root_text.txt")
    );
    ...
    assert_eq!(
        ...
        include_str!("../../../data/golden/cli_surface/config_root_json_pretty.txt")
    );
    ...
    assert_eq!(
        ...
        include_str!("../../../data/golden/cli_surface/config_root_json_compact.txt")
    );
    ...
    assert_eq!(
        ...
        include_str!("../../../data/golden/cli_surface/config_root_yaml_pretty.txt")
    );
}
...
fn root_config_subcommands_match_cli_config_subcommands() {
    ...
    let root_get =
        run(&["config", "get", "alpha", "--format", "json", "--no-pretty", "--config-path", path]);
...
fn cli_config_namespace_without_leaf_defaults_to_listing() {
    ...
    let cli = run(&["cli", "config", "--format", "json", "--no-pretty", "--config-path", path]);
