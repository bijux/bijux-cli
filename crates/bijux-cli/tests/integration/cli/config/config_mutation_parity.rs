...
fn config_unset_clear_reload_text_snapshots() {
    ...
    assert_eq!(
        ...
        include_str!("../../../data/golden/cli_surface/config_unset_text.txt")
    );
    ...
    assert_eq!(
        ...
        include_str!("../../../data/golden/cli_surface/config_clear_text.txt")
    );
    ...
    assert_eq!(
        ...
        include_str!("../../../data/golden/cli_surface/config_reload_text.txt")
    );
}
...
fn config_mutation_python_parity_for_exit_and_streams() {
    ...
    let py_clear = run_python(
        &["config", "clear", "--format", "json", "--no-pretty"],
        &envs,
    );
    ...
    let py_reload = run_python(
        &["config", "reload", "--format", "json", "--no-pretty"],
        &envs,
    );
