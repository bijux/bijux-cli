...
fn config_set_output_snapshots_text_json_yaml() {
    ...
    assert_eq!(
        ...
        include_str!("../../../data/golden/cli_surface/config_set_text.txt")
    );
    ...
    assert_eq!(
        ...
        include_str!("../../../data/golden/cli_surface/config_set_json_pretty.txt")
    );
    ...
    assert_eq!(
        ...
        include_str!("../../../data/golden/cli_surface/config_set_json_compact.txt")
    );
    ...
    assert_eq!(
        ...
        include_str!("../../../data/golden/cli_surface/config_set_yaml_pretty.txt")
    );
}
