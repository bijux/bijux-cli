...
fn help_snapshots_match_expected_output() {
    let cases: [(&[&str], &str); 45] = [
        (
            &["--help"],
            include_str!("../../../data/golden/cli_surface/help_root.txt"),
        ),
        (
            &["--color", "never", "--help"],
        ...
        (
            &["cli", "--help"],
            include_str!("../../../data/golden/cli_surface/help_cli.txt"),
        ),
        (
            &["dev", "--help"],
            include_str!("../../../data/golden/cli_surface/help_dev.txt"),
        ),
        (
            &["status", "--help"],
        ...
        (
            &["audit", "--help"],
            include_str!("../../../data/golden/cli_surface/help_audit.txt"),
        ),
        (
            &["docs", "--help"],
            include_str!("../../../data/golden/cli_surface/help_docs.txt"),
        ),
        (
            &["sleep", "--help"],
            include_str!("../../../data/golden/cli_surface/help_sleep.txt"),
        ),
        (
            &["version", "--help"],
            include_str!("../../../data/golden/cli_surface/help_version.txt"),
        ),
        (
            &["doctor", "--help"],
            include_str!("../../../data/golden/cli_surface/help_doctor.txt"),
        ),
        (
            &["config", "--help"],
            include_str!("../../../data/golden/cli_surface/help_config.txt"),
        ),
        (
            &["plugins", "--help"],
            include_str!("../../../data/golden/cli_surface/help_plugins.txt"),
        ),
        (
        ...
        (
            &["repl", "--help"],
            include_str!("../../../data/golden/cli_surface/help_repl.txt"),
        ),
        (
            &["completion", "--help"],
        ...
        (
            &["inspect", "--help"],
            include_str!("../../../data/golden/cli_surface/help_inspect.txt"),
        ),
        (
            &["history", "--help"],
            include_str!("../../../data/golden/cli_surface/help_history.txt"),
        ),
        (
            &["memory", "--help"],
            include_str!("../../../data/golden/cli_surface/help_memory.txt"),
        ),
        (
            &["cli", "status", "--help"],
