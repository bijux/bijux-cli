...
fn inspect_snapshots_match_json_yaml_and_text() {
    let cases: [(&[&str], &str); 3] = [
        (
            &["inspect", "--format", "json", "--pretty"],
            include_str!("../../../data/golden/cli_surface/inspect_json.txt"),
        ),
        (
...
fn dev_diagnostics_text_snapshots_match() {
    let cases: [(&[&str], &str); 8] = [
        (
            ...
            include_str!("../../../data/golden/cli_surface/dev_cli_routes_text.txt"),
        ),
        (
            &["dev", "cli", "registry", "--format", "text"],
            include_str!("../../../data/golden/cli_surface/dev_cli_registry_text.txt"),
        ),
        (
            &["dev", "cli", "env", "--format", "text"],
            include_str!("../../../data/golden/cli_surface/dev_cli_env_text.txt"),
        ),
        (
            &["dev", "cli", "doctor", "--format", "text"],
            include_str!("../../../data/golden/cli_surface/dev_cli_doctor_text.txt"),
        ),
        (
            &["dev", "cli", "contracts", "--format", "text"],
            include_str!("../../../data/golden/cli_surface/dev_cli_contracts_text.txt"),
        ),
        (
            &["dev", "cli", "runtime-identity", "--format", "text"],
            include_str!("../../../data/golden/cli_surface/dev_cli_runtime_identity_text.txt"),
        ),
        (
            &["dev", "cli", "state-audit", "--format", "text"],
            include_str!("../../../data/golden/cli_surface/dev_cli_state_audit_text.txt"),
        ),
        (
            &["dev", "cli", "state-doctor", "--format", "text"],
            include_str!("../../../data/golden/cli_surface/dev_cli_state_doctor_text.txt"),
        ),
    ];
...
fn state_diagnostics_no_color_snapshots_match() {
    let cases: [(&[&str], &str); 2] = [
        (
            &["dev", "cli", "state-audit", "--format", "text"],
            include_str!("../../../data/golden/cli_surface/dev_cli_state_audit_no_color.txt"),
        ),
        (
            &["dev", "cli", "state-doctor", "--format", "text"],
            include_str!("../../../data/golden/cli_surface/dev_cli_state_doctor_no_color.txt"),
        ),
    ];
