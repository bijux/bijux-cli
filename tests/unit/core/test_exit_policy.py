...
@pytest.mark.parametrize(
    ...
    [
        ...
        (ErrorType.USER_INPUT, ExitCode.ERROR, "stderr"),
...
def test_exit_behavior_matrix(
    ...
    behavior = resolve_exit_behavior(error_type, quiet=False, fmt=OutputFormat.JSON)
...
def test_exit_behavior_quiet_suppresses_output(error_type: ErrorType) -> None:
    behavior = resolve_exit_behavior(error_type, quiet=True, fmt=OutputFormat.JSON)
