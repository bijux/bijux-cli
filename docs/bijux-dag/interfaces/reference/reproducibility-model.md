...
- `docs/bijux-dag/operations/guides/cache-behavior-workflow.md`
...
- use [Cache Behavior Workflow](../../operations/guides/cache-behavior-workflow.md)
  when you want a full worked example of warm reuse, selective invalidation,
  corruption refusal, and cache-miss explanation
- use [Branching Bulletin Workflow](../../operations/guides/branching-bulletin-workflow.md)
  and [Compliance-Gated Bulletin Workflow](../../operations/guides/compliance-gated-bulletin-workflow.md)
