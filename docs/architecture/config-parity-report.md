...
- Binary-level parity tests: `crates/bijux-cli/tests/cli_surface/config_parity.rs`.
- Python-vs-Rust compatibility tests: `crates/bijux-cli/tests/cli_surface/config_python_compatibility.rs`.
