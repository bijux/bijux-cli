...
- Binary command coverage: `crates/bijux-cli/tests/cli_surface/config/config_set_parity.rs`
...
- Python compatibility coverage: `crates/bijux-cli/tests/cli_surface/config/config_python_compatibility.rs`

## Captured Outputs

- Text snapshot: `crates/bijux-cli/tests/cli_surface/snapshots/config_set_text.txt`
- JSON pretty snapshot: `crates/bijux-cli/tests/cli_surface/snapshots/config_set_json_pretty.txt`
- JSON compact snapshot: `crates/bijux-cli/tests/cli_surface/snapshots/config_set_json_compact.txt`
- YAML snapshot: `crates/bijux-cli/tests/cli_surface/snapshots/config_set_yaml_pretty.txt`
