...
- Text snapshot: `crates/bijux-cli/tests/snapshots/config_set_text.txt`
- JSON pretty snapshot: `crates/bijux-cli/tests/snapshots/config_set_json_pretty.txt`
- JSON compact snapshot: `crates/bijux-cli/tests/snapshots/config_set_json_compact.txt`
- YAML snapshot: `crates/bijux-cli/tests/snapshots/config_set_yaml_pretty.txt`
