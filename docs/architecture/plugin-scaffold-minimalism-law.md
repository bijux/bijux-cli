...
1. Snapshot updates in `crates/bijux-cli-bin/tests/snapshots/plugin_scaffold_*_minimal_files.txt`
2. Passing lifecycle regression in `crates/bijux-cli-bin/tests/plugin_scaffold_minimal.rs`
