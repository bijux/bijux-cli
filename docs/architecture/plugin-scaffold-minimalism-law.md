...
3. Regenerated scaffold reports via `bijux dev cli scripts status run --id STATUS-SCRIPT-GENERATE-PLUGIN-SCAFFOLD-REPORTS`
4. Policy pass via `bijux dev cli scripts status run --id STATUS-SCRIPT-ENFORCE-PLUGIN-SCAFFOLD-POLICY`
