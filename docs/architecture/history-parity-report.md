...
- `crates/bijux-cli-bin/tests/snapshots/history_root_json.txt`
- `crates/bijux-cli-bin/tests/snapshots/history_root_yaml.txt`
- `crates/bijux-cli-bin/tests/snapshots/history_root_text.txt`
