...
- Binary parity coverage:
  - `crates/bijux-cli-bin/tests/config_mutation_parity.rs`
- Snapshots:
  - `crates/bijux-cli-bin/tests/snapshots/config_unset_text.txt`
  - `crates/bijux-cli-bin/tests/snapshots/config_clear_text.txt`
  - `crates/bijux-cli-bin/tests/snapshots/config_reload_text.txt`
