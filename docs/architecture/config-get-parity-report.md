...
- Core behavior tests:
  ...
  - `crates/bijux-cli-core/tests/config_get_performance.rs`
- Binary behavior tests:
  - `crates/bijux-cli-core/tests/bin_surface/config_get_parity.rs`
  - `crates/bijux-cli-core/tests/bin_surface/config_python_compatibility.rs`
- Snapshot artifacts:
  - `crates/bijux-cli-core/tests/snapshots/config_get_text.txt`
  - `crates/bijux-cli-core/tests/snapshots/config_get_json_pretty.txt`
  - `crates/bijux-cli-core/tests/snapshots/config_get_json_compact.txt`
  - `crates/bijux-cli-core/tests/snapshots/config_get_yaml_pretty.txt`
