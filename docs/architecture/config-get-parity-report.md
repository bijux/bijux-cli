...
- Binary behavior tests:
  - `crates/bijux-cli-bin/tests/config_get_parity.rs`
  - `crates/bijux-cli-bin/tests/config_python_compatibility.rs`
- Snapshot artifacts:
  - `crates/bijux-cli-bin/tests/snapshots/config_get_text.txt`
  - `crates/bijux-cli-bin/tests/snapshots/config_get_json_pretty.txt`
  - `crates/bijux-cli-bin/tests/snapshots/config_get_json_compact.txt`
  - `crates/bijux-cli-bin/tests/snapshots/config_get_yaml_pretty.txt`
