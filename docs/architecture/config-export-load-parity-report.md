...
- Binary parity suite:
  - `crates/bijux-cli-bin/tests/config_export_load_parity.rs`
- Snapshots:
  - `crates/bijux-cli-bin/tests/snapshots/config_export_json_compact.txt`
  - `crates/bijux-cli-bin/tests/snapshots/config_export_yaml_pretty.txt`
  - `crates/bijux-cli-bin/tests/snapshots/config_export_text_error.txt`
