# Iteration 01 Goal Status (bijux-core)
...
| --- | --- | --- | --- |
| 1 | Freeze the workspace product map. | not-started | backlog baseline |
| 2 | Separate released product truth from maintainer truth. | not-started | backlog baseline |
| 3 | Enforce DAG crate dependency direction. | not-started | backlog baseline |
| 4 | Enforce CLI crate dependency direction. | not-started | backlog baseline |
| 5 | Define public versus internal modules. | not-started | backlog baseline |
| 6 | Quarantine simulated product claims. | not-started | backlog baseline |
| 7 | Create a backlog-to-crate routing table. | not-started | backlog baseline |
