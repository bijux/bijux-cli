...
| contracts/foundation/dag_release_truth_table.v1.json | bijux-dev | Defines the authoritative DAG operator surface truth table for stable, experimental, simulated, internal, and future routes. | crates/bijux-dev/tests/foundation_release_boundary_contracts.rs |
| contracts/foundation/workspace_package_boundary.v1.json | bijux-dev | Defines the authoritative workspace package public/private boundary and crates.io publication intent. | crates/bijux-dev/tests/foundation_workspace_package_boundary_contracts.rs |
...
| contracts/foundation/maintainer_command_surface.v1.json | bijux-dev | Defines the visible `bijux-dev-dag` root command inventory and freezes maintainer command-surface drift. | crates/bijux-dev/tests/foundation_maintainer_command_surface_contracts.rs |
