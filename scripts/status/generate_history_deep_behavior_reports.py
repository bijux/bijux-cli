...
TEST_FILES = [
    ROOT / "crates" / "bijux-cli-core" / "tests" / "bin_surface" / "history_command_matrix.rs",
    ROOT / "crates" / "bijux-cli-core" / "tests" / "bin_surface" / "history_parity.rs",
    ROOT / "crates" / "bijux-cli-core" / "tests" / "bin_surface" / "history_deep_behavior_extra.rs",
]
