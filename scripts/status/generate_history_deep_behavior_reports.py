...
TEST_FILES = [
    ROOT / "crates" / "bijux-cli-bin" / "tests" / "history_command_matrix.rs",
    ROOT / "crates" / "bijux-cli-bin" / "tests" / "history_parity.rs",
    ROOT / "crates" / "bijux-cli-bin" / "tests" / "history_deep_behavior_extra.rs",
]
