...
TEST_FILE = ROOT / "crates" / "bijux-cli-bin" / "tests" / "cross_surface_equivalence.rs"
...
def main() -> int:
    ...
    for todo, fn_name, law in REQUIRED_TESTS:
        row = {
            "todo": todo,
            "law": law,
            "test": f"crates/bijux-cli-bin/tests/cross_surface_equivalence.rs::{fn_name}",
        }
    ...
    equivalence = {
        ...
        "verification_command": "cargo test -q -p bijux-cli-bin --test cross_surface_equivalence",
        "covered": covered,
        "missing": missing,
        "summary": {
