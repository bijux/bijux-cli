...
HARNESS_TEST = ROOT / "crates" / "bijux-cli-bin" / "tests" / "randomized_state_corruption_harness.rs"
REGRESSION_TEST = ROOT / "crates" / "bijux-cli-bin" / "tests" / "randomized_state_corruption_regressions.rs"
MIN_CASES_DIR = ROOT / "crates" / "bijux-cli-bin" / "tests" / "fuzz" / "state_corruption_minimized_cases"
