...
SCAFFOLD_TARGETS = ROOT / "crates" / "bijux-cli-bin" / "tests" / "plugin_scaffold_fuzz_targets.rs"
SCAFFOLD_REGRESSION = ROOT / "crates" / "bijux-cli-bin" / "tests" / "plugin_scaffold_fuzz_regressions.rs"

MANIFEST_MIN_DIR = ROOT / "crates" / "bijux-cli-plugin" / "tests" / "fuzz" / "plugin_manifest_minimized_cases"
SCAFFOLD_MIN_DIR = ROOT / "crates" / "bijux-cli-bin" / "tests" / "fuzz" / "plugin_scaffold_minimized_cases"
...
def main() -> int:
    ...
    scaffold_targets_run = run_test(["cargo", "test", "-p", "bijux-cli-bin", "--test", "plugin_scaffold_fuzz_targets"])
    scaffold_reg_run = run_test(["cargo", "test", "-p", "bijux-cli-bin", "--test", "plugin_scaffold_fuzz_regressions"])
