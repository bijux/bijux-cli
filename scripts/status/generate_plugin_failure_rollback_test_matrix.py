...
TEST_FILE = ROOT / "crates" / "bijux-cli-core" / "tests" / "bin_surface" / "plugin_failure_rollback_matrix.rs"
        ...
        "rows": [
            {
                ...
                "evidence": "crates/bijux-cli-core/tests/bin_surface/plugin_failure_rollback_matrix.rs",
            }
