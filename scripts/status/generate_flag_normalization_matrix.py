...
TEST_FILE = ROOT / "crates" / "bijux-cli-core" / "tests" / "bin_surface" / "flag_normalization_matrix.rs"
        ...
        "rows": [
            {
                ...
                "evidence": "crates/bijux-cli-core/tests/bin_surface/flag_normalization_matrix.rs",
            }
