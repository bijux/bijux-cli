...
TEST_FILE = ROOT / "crates" / "bijux-cli-core" / "tests" / "bin_surface" / "plugin_lifecycle_matrix.rs"
        ...
        "rows": [
            {
                ...
                "evidence": "crates/bijux-cli-core/tests/bin_surface/plugin_lifecycle_matrix.rs",
            }
