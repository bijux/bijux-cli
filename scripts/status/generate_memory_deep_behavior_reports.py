...
TEST_FILES = [
    ROOT / "crates" / "bijux-cli-bin" / "tests" / "memory_command_matrix.rs",
    ROOT / "crates" / "bijux-cli-bin" / "tests" / "memory_parity.rs",
    ROOT / "crates" / "bijux-cli-bin" / "tests" / "memory_deep_behavior_extra.rs",
]
