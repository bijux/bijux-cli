...
TEST_FILE = ROOT / "crates" / "bijux-cli-bin" / "tests" / "config_read_matrix.rs"
...
def main() -> int:
    ...
    todo_rows = [
        {
            ...
            "evidence": "crates/bijux-cli-bin/tests/config_read_matrix.rs",
        }
    ...
    write_json(
        "config_read_domain_contract.json",
        {
            ...
            "evidence": [
                "crates/bijux-cli-bin/tests/config_read_matrix.rs",
