...
CAMPAIGN_TEST = ROOT / "crates" / "bijux-cli-bin" / "tests" / "state_race_campaigns.rs"
REGRESSION_TEST = ROOT / "crates" / "bijux-cli-bin" / "tests" / "state_race_campaign_regressions.rs"
MIN_CASES_DIR = ROOT / "crates" / "bijux-cli-bin" / "tests" / "fuzz" / "state_race_minimized_cases"
...
def main() -> int:
    ...
    campaign_run = run_test(["cargo", "test", "-p", "bijux-cli-bin", "--test", "state_race_campaigns"])
    regression_run = run_test(["cargo", "test", "-p", "bijux-cli-bin", "--test", "state_race_campaign_regressions"])
