...
def main() -> None:
    ...
    history_matrix = {
        ...
        "evidence_tests": [
            "crates/bijux-cli-bin/tests/history_memory_resilience_hardening.rs::history_truncated_mixed_invalid_and_duplicate_records_remain_recoverable",
            "crates/bijux-cli-bin/tests/history_memory_resilience_hardening.rs::history_enormous_line_layout_is_tolerated_with_tail_limit",
            "crates/bijux-cli-bin/tests/history_parity.rs::history_preserves_duplicate_commands_and_ordering",
            "crates/bijux-cli-bin/tests/history_parity.rs::history_skips_malformed_entries_inside_json_array",
        ],
    }
    ...
    memory_matrix = {
        ...
        "evidence_tests": [
            "crates/bijux-cli-bin/tests/history_memory_resilience_hardening.rs::memory_truncated_wrong_type_missing_fields_and_extra_fields_are_handled_safely",
            "crates/bijux-cli-bin/tests/history_memory_resilience_hardening.rs::memory_commands_are_read_only_even_when_home_storage_is_unwritable",
            "crates/bijux-cli-bin/tests/memory_parity.rs::memory_malformed_state_is_treated_as_empty_like_python",
            "crates/bijux-cli-bin/tests/memory_parity.rs::memory_non_object_json_state_fails_with_error_envelope",
        ],
    }
