...
TARGETS = ROOT / "crates" / "bijux-cli" / "tests" / "bin_surface" / "config_fuzz_targets.rs"
REGRESSION = ROOT / "crates" / "bijux-cli" / "tests" / "bin_surface" / "config_fuzz_regressions.rs"
MINIMIZED = ROOT / "crates" / "bijux-cli" / "tests" / "fuzz" / "config_minimized_cases"
...
def main() -> int:
    ...
    replay = run_test(
        ["cargo", "test", "-p", "bijux-cli", "--test", "bin_surface", "config_fuzz_regressions::"]
    )
