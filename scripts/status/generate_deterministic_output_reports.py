...
TEST_FILE = ROOT / "crates" / "bijux-cli-bin" / "tests" / "deterministic_output_matrix.rs"
...
def main() -> None:
        ...
        "rows": [
            {
                ...
                "evidence": "crates/bijux-cli-bin/tests/deterministic_output_matrix.rs",
            }
    ...
    dashboard = {
        ...
        "evidence": [
            "crates/bijux-cli-bin/tests/deterministic_output_matrix.rs",
