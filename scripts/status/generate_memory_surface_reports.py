...
MATRIX_TEST = ROOT / "crates" / "bijux-cli" / "tests" / "bin_surface" / "memory_command_matrix.rs"
PARITY_TEST = ROOT / "crates" / "bijux-cli" / "tests" / "bin_surface" / "memory_parity.rs"
        ...
        coverage_rows.append(
            {
                ...
                if in_matrix
                else "crates/bijux-cli/tests/bin_surface/memory_parity.rs",
            }
        )
