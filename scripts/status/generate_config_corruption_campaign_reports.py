...
CAMPAIGN_TEST = ROOT / "crates" / "bijux-cli-bin" / "tests" / "randomized_config_corruption_campaigns.rs"
REGRESSION_TEST = ROOT / "crates" / "bijux-cli-bin" / "tests" / "config_corruption_campaign_regressions.rs"
MIN_CASES_DIR = ROOT / "crates" / "bijux-cli-bin" / "tests" / "fuzz" / "config_corruption_minimized_cases"
...
def main() -> int:
    ...
    campaign_run = run_test(
        ["cargo", "test", "-p", "bijux-cli-bin", "--test", "randomized_config_corruption_campaigns"]
    )
    regression_run = run_test(
        ["cargo", "test", "-p", "bijux-cli-bin", "--test", "config_corruption_campaign_regressions"]
    )
    ...
    determinism = {
        ...
        "evidence": "crates/bijux-cli-bin/tests/randomized_config_corruption_campaigns.rs::repeated_run_corruption_inputs_are_deterministic_for_config_command_set",
    }
