...
SNAPSHOTS = {
    "dev cli doctor": ROOT / "crates" / "bijux-cli-bin" / "tests" / "snapshots" / "dev_cli_doctor_text.txt",
    "dev cli routes": ROOT / "crates" / "bijux-cli-bin" / "tests" / "snapshots" / "dev_cli_routes_text.txt",
    "dev cli registry": ROOT / "crates" / "bijux-cli-bin" / "tests" / "snapshots" / "dev_cli_registry_text.txt",
    "dev cli env": ROOT / "crates" / "bijux-cli-bin" / "tests" / "snapshots" / "dev_cli_env_text.txt",
}
