...
| evidence/perf/fixtures/planner_deep_chain.json | perf | transitional | root-owned | evidence/perf |  |
| evidence/perf/fixtures/planner_large_fanout.json | perf | transitional | root-owned | evidence/perf |  |
| evidence/perf/fixtures/planner_mixed_resources.json | perf | transitional | root-owned | evidence/perf |  |
| evidence/perf/fixtures/recovery/acceptance_suite.json | perf | transitional | root-owned | evidence/perf |  |
| evidence/perf/fixtures/recovery/power_loss_restart.json | perf | transitional | root-owned | evidence/perf |  |
| evidence/perf/fixtures/scheduler_diamond_fanout.json | perf | transitional | root-owned | evidence/perf |  |
| evidence/perf/fixtures/scheduler_linear_32.json | perf | transitional | root-owned | evidence/perf |  |
| evidence/perf/fixtures/scheduler_parallel_64.json | perf | transitional | root-owned | evidence/perf |  |
| evidence/perf/fixtures/scheduling/backfill_saturation.json | perf | transitional | root-owned | evidence/perf |  |
| evidence/perf/fixtures/scheduling/concurrency_pressure.json | perf | transitional | root-owned | evidence/perf |  |
| evidence/perf/fixtures/scheduling/cron_storm.json | perf | transitional | root-owned | evidence/perf |  |
| evidence/perf/scenarios/cache_heavy_canonical.json | perf | transitional | root-owned | evidence/perf |  |
| evidence/perf/scenarios/cache_heavy_lookup.json | perf | transitional | root-owned | evidence/perf |  |
| evidence/perf/scenarios/cache_metadata_growth.json | perf | transitional | root-owned | evidence/perf |  |
| evidence/perf/scenarios/deep_canonical.json | perf | transitional | root-owned | evidence/perf |  |
| evidence/perf/scenarios/deep_scheduler_overhead.json | perf | transitional | root-owned | evidence/perf |  |
| evidence/perf/scenarios/few_heavy_nodes_orchestration_overhead.json | perf | transitional | root-owned | evidence/perf |  |
| evidence/perf/scenarios/manifest_trace_volume_growth.json | perf | transitional | root-owned | evidence/perf |  |
| evidence/perf/scenarios/manifest_trace_write_amplification.json | perf | transitional | root-owned | evidence/perf |  |
| evidence/perf/scenarios/many_small_nodes_scheduler_overhead.json | perf | transitional | root-owned | evidence/perf |  |
| evidence/perf/scenarios/medium_canonical.json | perf | transitional | root-owned | evidence/perf |  |
| evidence/perf/scenarios/medium_execute_local.json | perf | transitional | root-owned | evidence/perf |  |
| evidence/perf/scenarios/memory_execute_many_nodes.json | perf | transitional | root-owned | evidence/perf |  |
| evidence/perf/scenarios/memory_import_export_path.json | perf | transitional | root-owned | evidence/perf |  |
| evidence/perf/scenarios/memory_parse_validate_large_graph.json | perf | transitional | root-owned | evidence/perf |  |
| evidence/perf/scenarios/memory_replay_path.json | perf | transitional | root-owned | evidence/perf |  |
| evidence/perf/scenarios/replay_canonical.json | perf | transitional | root-owned | evidence/perf |  |
| evidence/perf/scenarios/replay_verification_cost.json | perf | transitional | root-owned | evidence/perf |  |
| evidence/perf/scenarios/resource_budgets.json | perf | transitional | root-owned | evidence/perf |  |
| evidence/perf/scenarios/tiny_canonical.json | perf | transitional | root-owned | evidence/perf |  |
| evidence/perf/scenarios/tiny_parse_validate.json | perf | transitional | root-owned | evidence/perf |  |
| evidence/perf/scenarios/wide_canonical.json | perf | transitional | root-owned | evidence/perf |  |
| evidence/perf/scenarios/wide_scheduler_overhead.json | perf | transitional | root-owned | evidence/perf |  |
| evidence/compare/scenarios/artifact_inspectability.json | compare | transitional | root-owned | evidence/compare |  |
| evidence/compare/scenarios/cache_reuse_shape.json | compare | transitional | root-owned | evidence/compare |  |
| evidence/compare/scenarios/chain.json | compare | transitional | root-owned | evidence/compare |  |
| evidence/compare/scenarios/determinism.json | compare | transitional | root-owned | evidence/compare |  |
| evidence/compare/scenarios/diamond.json | compare | transitional | root-owned | evidence/compare |  |
| evidence/compare/scenarios/failure_diagnostics.json | compare | transitional | root-owned | evidence/compare |  |
| evidence/compare/scenarios/failure_propagation.json | compare | transitional | root-owned | evidence/compare |  |
| evidence/compare/scenarios/operator_inspectability.json | compare | transitional | root-owned | evidence/compare |  |
...
| evidence/battle/workflows/e2e_minimal.json | battle | transitional | root-owned | evidence/battle |  |
...
| evidence/cache/replay/match_case.json | battle | transitional | root-owned | evidence/battle |  |
| evidence/cache/replay/mismatch_case.json | battle | transitional | root-owned | evidence/battle |  |
| evidence/cache/replay/unsupported_version_case.json | battle | transitional | root-owned | evidence/battle |  |
